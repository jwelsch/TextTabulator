...
Follow the link for the [full public API documentation](https://github.com/jwelsch/TextTabulator/blob/main/docs/index-texttabulator.adapters.reflection.md).

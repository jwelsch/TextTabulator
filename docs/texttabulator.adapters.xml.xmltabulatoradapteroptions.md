...
### **XmlTabulatorAdapterOptions(INameTransform, XmlReaderSettings)**

Creates an object of type XmlTabulatorAdapterOptions.

```csharp
public XmlTabulatorAdapterOptions(INameTransform nodeNameTransform, XmlReaderSettings xmlReaderSettings)
```

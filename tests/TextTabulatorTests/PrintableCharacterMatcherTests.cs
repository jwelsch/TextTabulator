...
{
    public class PrintableCharacterMatcherTests
    {
        #region Test characters

        public static IEnumerable<object[]> NonPrintableCharacters => new object[][]
        {
            [0x00000], [0x0007F],
        ...
        public static IEnumerable<object[]> PrintableCharacters => new object[][]
        {
            [0x0009], // Tab
            [0x000A], // Line feed
        ...
        [Theory]
        [MemberData(nameof(NonPrintableCharacters))]
        public void When_c_is_nonprintable_character_then_return_false(int c)
        {
            var sut = new PrintableCharacterMatcher();

            var result = sut.IsMatch(c);

            Assert.False(result);
        }

        [Theory]
        [MemberData(nameof(PrintableCharacters))]
        public void When_c_is_printable_character_then_return_true(int c)
        {
            var sut = new PrintableCharacterMatcher();
